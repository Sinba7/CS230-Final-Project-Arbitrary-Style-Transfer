    ...
    with tf.Graph().as_default(), tf.Session() as sess:
        ...
        for epoch in range(EPOCHS):
            ...
            for batch in range(n_batches):
                ...
                print("select content images: {}~{}/{}, style images: {}~{}/{}".format(batch*BATCH_SIZE, batch*BATCH_SIZE+BATCH_SIZE, len(content_imgs_path), batch*BATCH_SIZE, batch*BATCH_SIZE+BATCH_SIZE, len(style_imgs_path)))
                ...
                c_loss, s_loss, t_loss, summary, _ = sess.run([content_loss, style_loss, loss, merged, train_op], feed_dict={content: content_batch, style: style_batch})
